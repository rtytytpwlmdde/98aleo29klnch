		...
		//if($jenis_ruangan != 'rutsin'){
			...
			if($result_rutin > 0 || $result_jadwal > 0){
				...
				foreach ($ruang_non_rutin as $non_rutin) {
					...
					$mulai = $jam_mulai_peminjaman;
					$selesai = $jam_selesai_peminjaman;
					$start = $jam_mulai_pemakaian;
					$end = $jam_selesai_pemakaian;

					if($selesai == $start){
						$jam_selesai_peminjaman == $jam_selesai_peminjaman - 1;
					}

					if($mulai == $end){
						$jam_mulai_peminjaman = $jam_mulai_peminjaman + 1;
					}
