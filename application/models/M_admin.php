...
class M_admin extends CI_Model{
	...
	function get_data_agenda_umum($date){
		...
		$this->db->where('peminjaman_non_rutin.status_wakadek', 'setuju');
	...
	function get_data_peminjaman_non_rutin($date){
		$this->db->select('peminjaman_non_rutin.id_peminjaman_non_rutin, peminjaman_non_rutin.status, peminjaman_non_rutin.status_wakadek, peminjaman_non_rutin.jam_mulai_peminjaman, peminjaman_non_rutin.jam_selesai_peminjaman, detail_peminjaman_non_rutin.id_ruangan, detail_peminjaman_non_rutin.id_jam_kuliah, peminjaman_non_rutin.tanggal_pemakaian');
		$this->db->from('peminjaman_non_rutin');
		$this->db->join('detail_peminjaman_non_rutin', 'peminjaman_non_rutin.id_peminjaman_non_rutin = detail_peminjaman_non_rutin.id_peminjaman_non_rutin');
		$this->db->where('peminjaman_non_rutin.tanggal_pemakaian',$date);
		$this->db->where('peminjaman_non_rutin.status_wakadek !=', 'tolak');
		$this->db->where('peminjaman_non_rutin.status !=', 'tolak');
		$this->db->distinct();
		$query=$this->db->get();
		return $query->result();
