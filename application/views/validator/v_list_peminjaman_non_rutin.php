                        ...
                        foreach ($peminjaman_non_rutin as $u){ ?>
                            ...
                            <td><?php echo $u->nip_validator?></td>
                             ...
                             <td class="sorting_1" style="">
                                ...
                                <a data-toggle="modal" class="btn btn-danger text-white" data-target="<?php foreach($penyelenggara as $acc){
																												if($u->penyelenggara == $acc->id_penyelenggara){
																													if($acc->status == "1"){ 
																														if($u->status_wakadek == 'tolak') { 
																															?> #modal_tolak<?php echo $u->id_peminjaman_non_rutin;
																														}else {
																															echo '#';
																														}
																													} else { 
							...
							<td class="sorting_1" style="">
                                    <?php if($u->status == 'tolak'){ ?>
                                       <a href="https://api.whatsapp.com/send?phone=<?php foreach ($mahasiswa as $a){if ($a->nim == $u->id_peminjam) :echo $a->telpon;endif;}?>
																			...
																			target="_blank" type="button" class="btn btn-default" title="Kirim Pemberitahuan">
