<div class="main-content-container container-fluid">
                  ...
                  <div class="page-header row no-gutters py-2">
                    ...
                    <form action="<?php echo site_url('validator/filter_peta_ruangan_non_rutin');?>"  method="get" style="float:right" >
                            ...
                            <?php 
                                ...
                                <tr>
                                    ...
                                    <?php foreach ($peminjaman_non_rutin as $pb){
                                        ...
                                        $pb_status =  $pb->status;
                                        $pb_status_wakadek =  $pb->status_wakadek;
                                        for ($time = $start; $time <= $end; $time++) {
                                        if($pb_ruang == $ruang){
                                          if($time == $waktu){
                                            ?> 
                                            <span 
                                              <?php if($pb_status == 'setuju' && $pb_status_wakadek == 'setuju'){ ?>
