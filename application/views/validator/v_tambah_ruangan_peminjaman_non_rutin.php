...
<div class="row">
    ...
    <div class="col-lg-4 col-md-12">
        ...
        <div class='card-body p-0'>
            ...
            <?php }else if($no != 1){?>
                        <?php foreach ($penyelenggara as $a){if ($a->id_penyelenggara == $u->penyelenggara) { ?>
            <a  href="<?php echo site_url('validator/ubah_status_peminjaman_non_rutin/1/'.$u->id_peminjaman_non_rutin.'/'.$u->id_peminjam.'/'.$a->status);?>" class="mb-2 btn btn-sm btn-primary mr-1"><info class="text-warning">Selesai</info></a>
            <?php }}  ?>
            <?php }?>
            <?php }else{ ?>
